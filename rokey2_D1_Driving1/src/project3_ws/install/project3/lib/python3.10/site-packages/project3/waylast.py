...
class WaypointNavigator(Node):
    def __init__(self, gui):
        ...
        self.waypoints = {
            ...
            #"3": self.create_pose(3.6279003456104704, -0.49848594152249687, -0.994453789409345, 0.10517443001696732),
            ...
            #"7": self.create_pose(0.21373855062423944, 1.5778874581586089, 0.003315222117917795, 0.9999945046360549),
            "7": self.create_pose( 1.3804259488730453,1.3094726692775238, 0.39033200573810595, 0.9206741689091028),
            #"8": self.create_pose(0.13548594906805056, 0.45124409939411064, 0.04494429443138941, 0.9989894946384895),
            "8": self.create_pose(1.4480420057507586, 0.9008003183975954, -0.4464297427305647, 0.8948186882299239),
            #"9": self.create_pose(0.2636797387500241, -0.6292745969310705, 0.024301906915626573, 0.9997046650487654),
            "9": self.create_pose(1.4303387442876556, -0.22721887656026704, -0.5007100003428423, 0.8656150966547839),
            #"kitchen": self.create_pose(0.20480307321346577, 0.07663624845166352, -0.07352593307828481, 0.9972933054848847),
    ...
    def get_result_callback(self, future):
        ...
        if result.status == 4:  # GoalStatus.STATUS_SUCCEEDED
            ...
            #self.gui.add_log(f"Goal failed with status: {result.status}", "ERROR")
            pass
